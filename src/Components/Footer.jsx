...
const Footer = () => {
    return (
        <div className='w-full h-fit flex'>
            <div className='w-1/2  px-8 py-8 flex flex-col justify-between'>
                <div className='text-[8vw] font-["Neue Montreal"] leading-[7vw] font-semibold tracking-tighter'><h1>EYE-</h1>
                    <h1>OPENING</h1>
                </div>
                <div>
            ...
            <div className='w-1/2 h-full overflow-hidden py-8'>
                <div className='text-[7vw] font-["Neue Montreal"] leading-[90px] font-semibol tracking-tighter'><h1>PRESENTATIONS</h1>
                </div>
                <div className=' w-fit text-md text-[#262723] mt-10'>
                    <h1 className=''>
                        S: <br /> <br />
                ...
                <div className=' w-full text-md text-[#262723] mt-10 flex justify-between pr-5'>
                    <h1 className=''>
                        L: <br /> <br />
                        <p > <span className='im'>202-1965 W 4th Ave</span></p>
                        <p> <span className='im'>Vancouver, Canada</span></p>
                        <br /><br />
                        <p> <span className='im'>30 Chukarina St</span></p>
                        <p> <span className='im'>Lviv, Ukraine</span></p>
                    </h1>
                    <h1 className='max-md:hidden'>
                        M: <br /> <br />
                        <p > <span className='im'>Home</span></p>
                        <p> <span className='im'>Services</span></p>
                        <p> <span className='im'>Our work</span></p>
                        <p> <span className='im'>About us</span></p>
                        <p> <span className='im'>Insights</span></p>
                        <p> <span className='im'>Contact us</span></p>
                    </h1>
                </div>
                <div className=' w-fit text-md text-[#262723] mt-10'>
                    <h1 className=''>
                        E: <br /> <br />
                        <p > <span className='im'>hello@ochi.design</span></p>
                    </h1>
                </div> <br />
                <p className='text-[#dadada]'>© ochi design 2024.Legal Terms</p>
            </div>
        </div>
    )
}
